...
"</head>";
var p2="<body><div ><img alt=\"encart\" height=\"94\" src=\"imageTest2.jpg\" width=\"727\"><br></div>"+
...
"<link href=\"MFormat.css\" rel=\"stylesheet\" type=\"text/css\">"+
"</head>";
var m2="<body><div ><img alt=\"encart\" height=\"94\" src=\"imageTest2.jpg\" width=\"727\"><br></div>"+
"<form action=\"transit.html\" method=\"post\"><div id=\"bk_Hid\">"+
...
"if(lgn_chp[i].firstElementChild.nodeName===\"INPUT\")"+
"{lgn_chp[i].firstElementChild.value= exa_Grp[lgn_chp[i].firstElementChild.name]}"+
"else if(lgn_chp[i].firstElementChild.multiple)"+
"{for (var j= 0; j < lgn_chp[i].firstElementChild.options.length; j++){"+
"let cph=lgn_chp[i].firstElementChild.options[j].textContent;"+
"for (var l= 0; l < CvED.length; l++){"+
"if(cph===CvED[l]){let NvS=document.createElement(\"option\");NvS.selected=\"selected\";"+
"NvS.textContent=CvED[l];"+
"lgn_chp[i].firstElementChild.options[j].replaceWith(NvS);}}}}"+
...
"<script>document.getElementById(\"mdf\").addEventListener('click',Apg_Mdf);"+
"document.getElementById(\"enr_sv\").addEventListener('click',R_Mdf);"+
"function Apg_Mdf(){window.location.href=\"Modif.html\";} function R_Mdf(){window.location.href=\"/\";} </script></body></html>";
...
const info_pM= txt_md.parse(txt_dM);
let info_persTM="",info_persM="", info_exaM="";
...
"<link href=\"MFormat.css\" rel=\"stylesheet\" type=\"text/css\">"+
"</head>";
var mM2="<body><div ><img alt=\"encart\" height=\"94\" src=\"imageTest2.jpg\" width=\"727\"><br></div>"+
"<form action=\"transit.html\" method=\"post\"><div id=\"bk_Hid\">"+
"<label>ID (Auto): <input name=\"_id\" type=\"text\" autocomplete=\"off\" readonly=\"readonly\" ></label><br>"+
"<label>Nom: <input list=\"nomf\" name=\"nom\" type=\"text\" autocomplete=\"off\" ><datalist id=\"nomf\">";
...
"for (var i= 0; i < lgn_chp.length; i++){"+
"if(lgn_chp[i].firstElementChild.nodeName===\"INPUT\")"+
"{lgn_chp[i].firstElementChild.value= exa_GrpM[lgn_chp[i].firstElementChild.name]}"+
"else if(lgn_chp[i].firstElementChild.multiple)"+
"{for (var j= 0; j < lgn_chp[i].firstElementChild.options.length; j++){"+
"let cph=lgn_chp[i].firstElementChild.options[j].textContent;"+
"for (var l= 0; l < CvED.length; l++){"+
